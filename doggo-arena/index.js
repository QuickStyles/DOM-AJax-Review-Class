...
const roster = document.querySelector('.team.salmon').querySelector('.roster');

roster.appendChild(drillBitDarel);
// drillBitDarel.innerHTML = '<h1>Drill Bit Darel</h1>'
// or
const drillBitDarelHeader = document.createElement('h1');
drillBitDarelHeader.innerText = 'Drill Bit Darel'

drillBitDarel.appendChild(drillBitDarelHeader);